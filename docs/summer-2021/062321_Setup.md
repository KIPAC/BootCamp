...
- Setting up your unix startup scripts, see [this notebook](../../Unix/Unix%20(2).ipynb) - We probably won't cover this during the session, but it a resource available if you need it. 
