...
**Warning:** There have been significant updates made to this repoistory up until Monday evening, and some small changes may still be made over the course of the day Tuesday. That means if you downloaded this repository before Tuesday, you'll need to update it. If you downloaded it using a `git clone` command, you can get updates by navigating to the Bootcamp workspace and typing `git pull`. If you downloaded it a zip file, you'll just have to do that again. If you downloaded it early on Tuesday, you may want to re-download later in the day to catch any small updates, but that's less crucial. 
